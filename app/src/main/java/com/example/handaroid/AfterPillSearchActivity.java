...
public class AfterPillSearchActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_after_camera_pill);
        ...
        btn_send.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                progress = new ProgressDialog(AfterPillSearchActivity.this);
                progress.setMessage("사진 파일 전송중...");
                progress.show();
    ...
    private void sendImage() {
        ...
        String flask_url = "http://192.168.0.103:5000/sendPillimg";
        String url = "";
        StringRequest request = new StringRequest(Request.Method.POST, flask_url,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        // response 받아서 스트링 나눠주는 split 코드 작성해야함
                        //String send_result = response.split("자르기")[0];
                        String pill_name = response;

                        //if(//send_result.equals("true")){
                            //Toast.makeText(AfterPillSearchActivity.this, "Uploaded Successful", Toast.LENGTH_LONG).show();
                       // }
                        //else{
                            //Toast.makeText(AfterPillSearchActivity.this, "Some error occurred!", Toast.LENGTH_LONG).show();
                        //}

//                        tvPillname.setText("약 이름은 : " + pill_name);
                        ...
                        Intent intent = new Intent(getApplicationContext(), SufShowitemActivity.class);
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        progress.dismiss();
                        Toast.makeText(AfterPillSearchActivity.this, "Some error occurred -> "+error, Toast.LENGTH_LONG).show();
                    }
                }){
            @Override
    ...
    private void init() {
        ...
        queue = Volley.newRequestQueue(AfterPillSearchActivity.this);
    ...
    private void requestPermission() {
        ...
        if (ActivityCompat.checkSelfPermission(getApplicationContext(), Manifest.permission.CAMERA) != PackageManager.PERMISSION_GRANTED) { // 저장소에 데이터를 쓰는 권한을 부여받지 않았다면~
            ...
            ActivityCompat.requestPermissions(AfterPillSearchActivity.this, new String[]{Manifest.permission.CAMERA,
