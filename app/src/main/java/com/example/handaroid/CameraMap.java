...
public class CameraMap extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_send.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(getApplicationContext(),f3.class);
                startActivity(intent);
            }
        });
    }
        ...
        StringRequest request = new StringRequest(Request.Method.POST, flask_url,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        if(send_result.equals("true")){
                            Toast.makeText(CameraMap.this, "Uploaded Successful", Toast.LENGTH_LONG).show();
                        }
                        else{
                            Toast.makeText(CameraMap.this, "Some error occurred!", Toast.LENGTH_LONG).show();
                        }
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        progress.dismiss();
                        Toast.makeText(CameraMap.this, "Some error occurred -> "+error, Toast.LENGTH_LONG).show();
                    }
                }){
            @Override
    ...
    private void init() {
        ...
        queue = Volley.newRequestQueue(CameraMap.this);
    ...
    private void requestPermission() {
        ...
        if (ActivityCompat.checkSelfPermission(getApplicationContext(), Manifest.permission.CAMERA) != PackageManager.PERMISSION_GRANTED) { // 저장소에 데이터를 쓰는 권한을 부여받지 않았다면~
            ...
            ActivityCompat.requestPermissions(CameraMap.this, new String[]{Manifest.permission.CAMERA,
