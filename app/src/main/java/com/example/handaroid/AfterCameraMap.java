...
public class AfterCameraMap extends AppCompatActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_after_camera_map);
        ...
        StringRequest request = new StringRequest(Request.Method.POST, flask_url,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        if(send_result.equals("true")){
                            Toast.makeText(AfterCameraMap.this, "Uploaded Successful", Toast.LENGTH_LONG).show();
                        }
                        else{
                            Toast.makeText(AfterCameraMap.this, "Some error occurred!", Toast.LENGTH_LONG).show();
                        }
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        progress.dismiss();
                        Toast.makeText(AfterCameraMap.this, "Some error occurred -> "+error, Toast.LENGTH_LONG).show();
                    }
                }){
            @Override
    ...
    private void init() {
        ...
        queue = Volley.newRequestQueue(AfterCameraMap.this);
    ...
    private void requestPermission() {
        ...
        if (ActivityCompat.checkSelfPermission(getApplicationContext(), Manifest.permission.CAMERA) != PackageManager.PERMISSION_GRANTED) { // 저장소에 데이터를 쓰는 권한을 부여받지 않았다면~
            ...
            ActivityCompat.requestPermissions(AfterCameraMap.this, new String[]{Manifest.permission.CAMERA,
