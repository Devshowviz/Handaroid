...
public class PillSearchActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_camera_pill);
        ...
        btn_send.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                progress = new ProgressDialog(PillSearchActivity.this);
        ...
        StringRequest request = new StringRequest(Request.Method.POST, flask_url,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        //pill_name = response.split("자르기")[1];

                       // if(send_result.equals("true")){
                            //Toast.makeText(PillSearchActivity.this, "Uploaded Successful", Toast.LENGTH_LONG).show();
                       // }
                       // else{
                           // Toast.makeText(PillSearchActivity.this, "Some error occurred!", Toast.LENGTH_LONG).show();
                       // }
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        progress.dismiss();
                        Toast.makeText(PillSearchActivity.this, "Some error occurred -> "+error, Toast.LENGTH_LONG).show();
                    }
                }){
            @Override
    ...
    private void init() {
        ...
        queue = Volley.newRequestQueue(PillSearchActivity.this);
    ...
    private void requestPermission() {
        ...
        if (ActivityCompat.checkSelfPermission(getApplicationContext(), Manifest.permission.CAMERA) != PackageManager.PERMISSION_GRANTED) { // 저장소에 데이터를 쓰는 권한을 부여받지 않았다면~
            ...
            ActivityCompat.requestPermissions(PillSearchActivity.this, new String[]{Manifest.permission.CAMERA,
